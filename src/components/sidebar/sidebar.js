...
function Sidebar()
{
    ...
    const presentation = "Bonjour, Je m'appelle Assadi Halifa et Je suis developpeur junior. Bienvenue dans mon portfolio";
    library.add(fab,fas);
            ...
            <div  className={styles.content}>
                ...
                <h1  className={styles.titleSideBar}>{name}</h1>
                    ...
                    <div ref={profileRef} className={styles.profile}>
                        ...
                        <img className={styles.profileImage} src={photoProfile} alt="photo_profile"/>

...
const projectData = [
...

  {
    ...
    annee: "2020",
    description:
      "Appli web réaliseé avec le framework Symfony  4 et MDBoostrap, site one page du serveur GTA V RP LS Paradise, afin de permettre au joueurs inscrit de voir leurs données stockées dans la base de donnée,Refonte du site avec symfony 5 et reacpour la partie front ",

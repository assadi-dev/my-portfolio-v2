...
const projectData = [{
...

    {
        ...
        categorie: "Application web",
        annee: "2020",
        description: "Appli web réaliseé avec le framework react js cette application et un clone du célèbre site Twitch dédié au streaming, ceci à l'aide de l'api fourni par Twitch ",
